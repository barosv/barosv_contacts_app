...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 5826597131282115451),
      name: 'Contact',
      lastPropertyId: const IdUid(10, 807977448197609356),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2838729798362250537),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8625237150725837953),
            name: 'contactID',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 3752416981209575034),
            name: 'firstName',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 2146203206849032635),
            name: 'lastName',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 7111083152560853494),
            name: 'phoneNumber',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 3339060870858391043),
            name: 'streetAddress1',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(7, 3909831762858865611),
            name: 'streetAddress2',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(8, 5188905493197189001),
            name: 'city',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(9, 2914235938131459631),
            name: 'state',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(10, 807977448197609356),
            name: 'zipCode',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 5826597131282115451),
